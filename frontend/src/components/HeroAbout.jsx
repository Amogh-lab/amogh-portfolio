    ...
    <>
      <section className="hero-about-wrapper">
        <div className="hero-about-card">
          ...
          <p className="name">Hi, I'm Amogh A P,</p>
          <p className="card">
            an aspiring developer currently learning AI & ML at RVCE.
          ...
          <div className="button-group">
            <a href="https://github.com/Amogh-lab" target="_blank" rel="noopener noreferrer" className="btn">
              GitHub
            </a>
            <a href="https://www.linkedin.com/in/amogh-ap-750832293/" target="_blank" rel="noopener noreferrer" className="btn">
              LinkedIn
            </a>
          </div>
        </div>
